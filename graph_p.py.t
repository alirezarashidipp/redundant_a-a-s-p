...
def phase1_lock(state: WorkflowState) -> dict:
    ...
    if not state.get("user_injected_response"):
        ...
        if retries >= 3:
            return {
                "is_aborted": True,
                "abort_reason": f"System could not clarify '{display_name}' after 3 attempts.",
...
def _route_start(state: WorkflowState) -> str:
    ...
    routes = {
        ...
        "phase1": "phase1_lock",
        "phase2": "phase2_tech_lead",
        "phase2_ask": "phase2_ask_questions",
